...
const NEW_LAYOUT_VISUALS: Record<LayoutTemplate, { name: string; squareVisual: string; landscapeVisual: string }> = {
  statement: {
    name: 'Statement',
    squareVisual: `LAYOUT (Square 1:1): Bold geometric color-block grid. No white space — every zone filled with a flat brand color. Left 60% column: eggplant (#3D1935) background — top-right: Everstage colorful logo (multicolor icon + white "Everstage" wordmark). Below logo: large bold white headline text with one key phrase in hot pink (#CF3070). White subheadline below. 2-3 bullet lines in peach/cream (#F5CEB0) text. Near bottom: CTA button in warm orange (#E8893B) with dark maroon text. Right 40%: split into 2-3 stacked color blocks — top block teal (#1BA894), middle block periwinkle (#5465D4), bottom block warm tan (#B8764A). Each block solid flat color, no text. Geometric dividing lines are crisp and clean. Modern, vibrant, editorial B2B aesthetic.`,
    landscapeVisual: `LAYOUT (Landscape 1.5:1): Bold geometric color-block grid. Left 55%: eggplant (#3D1935) — top-right: Everstage colorful logo (multicolor icon + white wordmark). Below: large bold white headline with key phrase in hot pink (#CF3070). White subheadline. 2-3 bullet lines in peach (#F5CEB0). CTA button in orange (#E8893B) with dark maroon text. Right 45%: 3 stacked flat color blocks — teal (#1BA894) top, periwinkle (#5465D4) middle, warm tan (#B8764A) bottom. Clean geometric grid, no gradients, no white space.`,
  },
  'pain-story': {
    name: 'Pain Story',
  ...
  'data-card': {
    ...
    landscapeVisual: `LAYOUT (Landscape 1.5:1): Peach (#F5CEB0) base. Top-right: Everstage colorful logo (dark maroon). Bold dark maroon headline, stat in periwinkle. Large hot pink stat number center-left. Right: teal (#1BA894) block with white bullets. Bottom strip: eggplant (#3D1935) with report mockup. Flat geometric color zones.`,
  },
  testimonial: {
    name: 'Testimonial',
...
const LAYOUT_VISUALS: Record<LayoutTemplate, { name: string; squareVisual: string; landscapeVisual: string }> = {
  ...
  'pain-story': {
    name: 'Pain Story',
    squareVisual: `LAYOUT (Square 1:1): Two-tone vertical layout. Top 60%: Dark charcoal (#1A1A1A) background — top-right: Everstage "everstage" logo in white, small. Below logo: large bold white headline text with key words in gold/amber (#F5A623), dramatic and punchy. Center-right: Realistic photo of a stressed, focused ops manager or finance director at a cluttered desk — laptop open, papers stacked, looking overwhelmed. Top-right: Semi-transparent notification UI cards (simulating Slack/email alerts) with red badges showing commission errors and discrepancies cascading down. Middle-right: A sticky note reading "CHECK AGAIN." Bottom 25%: Light cream (#F5F5E8) strip with 2-3 concise bullet points in amber text (matching the body copy). Very bottom: Full-width dark navy bar with a gold/amber rounded CTA button right-aligned.`,
    landscapeVisual: `LAYOUT (Landscape 1.5:1): Two-tone horizontal layout. Main dark charcoal (#1A1A1A) background, upper 65%. Top-right: Everstage "everstage" logo in white, small. Below logo: bold large white headline with amber accent words — stacked dramatically. Below: 2-3 bullet points in gold text. Center: Stressed ops/finance professional photo at desk, overwhelmed. Right: Notification cards (Slack, Email) cascading with commission errors. Bottom 20%: Cream strip with solution bullets in amber. Very bottom: Full-width dark navy CTA bar, gold button right.`,
  },
  'data-card': {
    name: 'Data Card',
